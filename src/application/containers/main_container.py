...
from ...core.interfaces.services import IGameAnalyzer, IAutomationService, IStateManager
from ...core.interfaces.repositories import IConfigRepository, ITemplateRepository
from ...core.interfaces.adapters import IWindowAdapter, IInputAdapter

from ...infrastructure.services.game_analyzer_service import GameAnalyzerService
from ...infrastructure.services.automation_service import AutomationService
from ...infrastructure.services.state_manager_service import StateManagerService
