...
from design_tokens import ComponentSize
...
class ComponentShowcase(QWidget):
    ...
    def add_input_section(self, layout: VBox):
        ...
        basic_layout = Grid(columns=2, parent=basic_card)
        basic_layout.spacing = 16
        ...
        basic_layout.add_widget(NumberInput(min_value=0, max_value=100), 1, 1)
    ...
    def add_progress_section(self, layout: VBox):
        ...
        for label, style, value in progress_bars:
