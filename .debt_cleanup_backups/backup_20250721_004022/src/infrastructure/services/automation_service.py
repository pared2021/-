...
from src.core.interfaces.services import IAutomationService, IGameAnalyzer, AutomationStatus, ActionResult
from src.core.interfaces.adapters import IInputAdapter
