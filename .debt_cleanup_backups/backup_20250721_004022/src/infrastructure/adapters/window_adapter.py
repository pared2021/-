...
from src.core.interfaces.adapters import IWindowAdapter, WindowInfo
...
# 导入现有的窗口管理器实现
from src.services.window_manager import GameWindowManager, WindowInfo as ServiceWindowInfo
